...
import { Ref, ref, reactive, UnwrapRef, inject } from 'vue';
...
// /**
//  * Uvicore ORM style API client ModelFactory base class
//  * @returns ModelFactory
//  */
// export function ModelFactory<E>(model: any) {
...
//     public newRef(): Ref<UnwrapRef<Results<E>>> {
//       return ref<Results<E>>(new Results());
//     }
